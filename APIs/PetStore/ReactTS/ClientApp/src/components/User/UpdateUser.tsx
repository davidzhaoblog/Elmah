...
import { updateUser } from 'src/features/PetStore/UserSlice';
...
export default function UpdateUser(props: IFormProps<User> & IPopupProps) {
    ...
    const onSubmit = (data: any) => {
        ...
        dispatch(updateUser(dataToUpsert))
        console.log(data);
