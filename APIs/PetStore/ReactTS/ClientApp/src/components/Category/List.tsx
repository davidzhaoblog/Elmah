...
import { Category } from 'src/features//PetStore/Category';

function ListItem(props: IListItemProps<Category>) {
...
export default function List(props: IListProps<Category>) {
    return (
        <div>
