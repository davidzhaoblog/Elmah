...
#if DEBUG
        public const string WebApiRootUrl_General = "http://localhost:7905/api/";
        public const string WebApiRootUrl_Android = "http://10.0.2.2:7905/api/";
        public const string WebApiRootUrl_IOS = "http://localhost:7905/api/";
#else
