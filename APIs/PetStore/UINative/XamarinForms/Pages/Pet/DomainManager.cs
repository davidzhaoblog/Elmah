...
namespace Elmah.PetStore.XamarinForms.Pages.Pet
{
    public class DomainManager : Framework.Xamariner.Interfaces.IDomainManager
    {
        ...
        public Framework.Xaml.DomainModel CreateDomainModel()
        {
            ...
            domainModel.AddRelativeRoute(Elmah.PetStore.ViewModels.NavigationVM.PetActions.FindPetsByStatus.ToString(), typeof(Elmah.PetStore.XamarinForms.FindPetsByStatusPage), false);

            // Get.2. FindPetsByTags - /pet/findByTags
            domainModel.AddRelativeRoute(Elmah.PetStore.ViewModels.NavigationVM.PetActions.FindPetsByTags.ToString(), typeof(Elmah.PetStore.XamarinForms.FindPetsByTagsPage), false);
