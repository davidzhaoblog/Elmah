...
namespace Elmah.Services
{
        ...
        : IElmahApplicationService
    {
        ...
        public async Task<ElmahApplicationCompositeModel> GetCompositeModel(ElmahApplicationIdentifier id, ElmahApplicationCompositeDataOptions[]? dataOptions = null)
        {
