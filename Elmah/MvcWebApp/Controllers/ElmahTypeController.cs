...
namespace Elmah.MvcWebApp.Controllers
{
    public class ElmahTypeController : Controller
    {
        ...
        {
            var listItemRequests = new Dictionary<ElmahTypeCompositeModel.__DataOptions__, CompositeListItemRequest>();

            listItemRequests.Add(ElmahTypeCompositeModel.__DataOptions__.ElmahErrors_Via_Type,
            ...
            result.UIParamsList.Add(
                ElmahTypeCompositeModel.__DataOptions__.__Master__,
                new UIParams { PagedViewOption = PagedViewOptions.Card, Template = ViewItemTemplateNames.Details.ToString() });

            result.UIParamsList.Add(
                ElmahTypeCompositeModel.__DataOptions__.ElmahErrors_Via_Type,
            ...
            ElmahTypeIdentifier id)
        {
            ...
            {
                UIItemFeatures = _viewFeatureManager.GetElmahTypeUIItemFeatures(view),
