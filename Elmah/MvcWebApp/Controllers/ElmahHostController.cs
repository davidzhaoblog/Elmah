...
namespace Elmah.MvcWebApp.Controllers
{
    public class ElmahHostController : Controller
    {
        ...
        {
            var result = await _thisService.Search(query);
            var pagedViewModel = new ListViewModel<ElmahHostDataModel[]>
            {
            ...
            ElmahHostIdentifier id)
        {
            ...
            var itemViewModel = new Framework.Mvc.Models.MvcItemViewModel<ElmahHostDataModel>
            {
                        ...
                        return PartialView("~/Views/Shared/_AjaxResponse.cshtml",
                            new AjaxResponseViewModel
                            {
                                ...
                                new Tuple<string, object>("~/Views/ElmahHost/_TableItemTr.cshtml",
                                    new Framework.Mvc.Models.MvcItemViewModel<ElmahHostDataModel>{
                                        UIItemFeatures = _viewFeatureManager.GetElmahHostUIItemFeatures(),
                                        Status = System.Net.HttpStatusCode.OK,
