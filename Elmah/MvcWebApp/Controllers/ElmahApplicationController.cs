...
namespace Elmah.MvcWebApp.Controllers
{
    public class ElmahApplicationController : Controller
    {
        ...
        public async Task<IActionResult> Index(ElmahApplicationAdvancedQuery query, UIParams uiParams)
        {
            ...
            return View(new PagedSearchViewModel<ElmahApplicationAdvancedQuery, ElmahApplicationModel[]>
            {
                Query = query,
        ...
        public async Task<IActionResult> Dashboard([FromRoute]ElmahApplicationIdentifier id)
        {
            ...
            result.UIParamsList.Add(Elmah.Models.ElmahApplicationCompositeModel.__DataOptions__.ElmahErrors_Via_Application, new UIParams { PagedViewOption = Framework.Models.PagedViewOptions.Table, Template = Framework.Models.ViewItemTemplateNames.Details });
            return View(result);
        }
