...
namespace Elmah.AspNetMvcCoreViewModel.ElmahStatusCode
{
    public partial class DashboardVM
        : Elmah.ViewModelData.ElmahStatusCode.DashboardVM
    {
        ...
        public async Task LoadData(Elmah.ViewModelData.ElmahStatusCode.DashboardVMDataOptions[] dataOptions)
        {
            using (var scope = ServiceProvider.CreateScope())
            {
                ...
                if (masterEntityResult.BusinessLogicLayerResponseStatus == Framework.Services.BusinessLogicLayerResponseStatus.MessageOK)
                {
                    ...
                    if(dataOptions == null || dataOptions.Contains(Elmah.ViewModelData.ElmahStatusCode.DashboardVMDataOptions.ELMAH_Error))
                    {
                        tasks.Add(Task.Run(async () => {
                        this.CriteriaOfELMAH_Error.Common.StatusCode = new Framework.Queries.QuerySystemInt32EqualsCriteria(this.MasterEntity.StatusCode);
                            ...
                            this.ResponseStatuses.Add(resultELMAH_Error.GetStatusMessage<Elmah.ViewModelData.ElmahStatusCode.DashboardVMDataOptions>(
                                Elmah.ViewModelData.ElmahStatusCode.DashboardVMDataOptions.ELMAH_Error, Framework.Services.BusinessLogicLayerRequestTypes.Search));
