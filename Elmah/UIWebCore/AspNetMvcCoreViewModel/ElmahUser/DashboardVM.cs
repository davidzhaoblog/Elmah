...
namespace Elmah.AspNetMvcCoreViewModel.ElmahUser
{
    public partial class DashboardVM
        : Elmah.ViewModelData.ElmahUser.DashboardVM
    {
        ...
        public async Task LoadData(Elmah.ViewModelData.ElmahUser.DashboardVMDataOptions[] dataOptions)
        {
            using (var scope = ServiceProvider.CreateScope())
            {
                ...
                if (masterEntityResult.BusinessLogicLayerResponseStatus == Framework.Services.BusinessLogicLayerResponseStatus.MessageOK)
                {
                    ...
                    if(dataOptions == null || dataOptions.Contains(Elmah.ViewModelData.ElmahUser.DashboardVMDataOptions.ELMAH_Error))
                    {
                        tasks.Add(Task.Run(async () => {
                        this.CriteriaOfELMAH_Error.Common.User = new Framework.Queries.QuerySystemStringEqualsCriteria(this.MasterEntity.User);
                            ...
                            this.ResponseStatuses.Add(resultELMAH_Error.GetStatusMessage<Elmah.ViewModelData.ElmahUser.DashboardVMDataOptions>(
                                Elmah.ViewModelData.ElmahUser.DashboardVMDataOptions.ELMAH_Error, Framework.Services.BusinessLogicLayerRequestTypes.Search));
