...
namespace Elmah.AspNetMvcCoreViewModel.ElmahSource
{
    public partial class DashboardVM
        : Elmah.ViewModelData.ElmahSource.DashboardVM
    {
        ...
        public async Task LoadData(Elmah.ViewModelData.ElmahSource.DashboardVMDataOptions[] dataOptions)
        {
            using (var scope = ServiceProvider.CreateScope())
            {
                ...
                if (masterEntityResult.BusinessLogicLayerResponseStatus == Framework.Services.BusinessLogicLayerResponseStatus.MessageOK)
                {
                    ...
                    if(dataOptions == null || dataOptions.Contains(Elmah.ViewModelData.ElmahSource.DashboardVMDataOptions.ELMAH_Error))
                    {
                        tasks.Add(Task.Run(async () => {
                        this.CriteriaOfELMAH_Error.Common.Source = new Framework.Queries.QuerySystemStringEqualsCriteria(this.MasterEntity.Source);
                            ...
                            this.ResponseStatuses.Add(resultELMAH_Error.GetStatusMessage<Elmah.ViewModelData.ElmahSource.DashboardVMDataOptions>(
                                Elmah.ViewModelData.ElmahSource.DashboardVMDataOptions.ELMAH_Error, Framework.Services.BusinessLogicLayerRequestTypes.Search));
