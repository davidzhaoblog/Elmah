...
namespace Elmah.AspNetMvcCoreViewModel.ElmahHost
{
    public partial class DashboardVM
        : Elmah.ViewModelData.ElmahHost.DashboardVM
    {
        ...
        public async Task LoadData(Elmah.ViewModelData.ElmahHost.DashboardVMDataOptions[] dataOptions)
        {
            using (var scope = ServiceProvider.CreateScope())
            {
                ...
                if (masterEntityResult.BusinessLogicLayerResponseStatus == Framework.Services.BusinessLogicLayerResponseStatus.MessageOK)
                {
                    ...
                    if(dataOptions == null || dataOptions.Contains(Elmah.ViewModelData.ElmahHost.DashboardVMDataOptions.ELMAH_Error))
                    {
                        tasks.Add(Task.Run(async () => {
                        this.CriteriaOfELMAH_Error.Common.Host = new Framework.Queries.QuerySystemStringEqualsCriteria(this.MasterEntity.Host);
                            ...
                            this.ResponseStatuses.Add(resultELMAH_Error.GetStatusMessage<Elmah.ViewModelData.ElmahHost.DashboardVMDataOptions>(
                                Elmah.ViewModelData.ElmahHost.DashboardVMDataOptions.ELMAH_Error, Framework.Services.BusinessLogicLayerRequestTypes.Search));
