...
namespace Elmah.AspNetMvcCoreViewModel.ElmahType
{
    public partial class DashboardVM
        : Elmah.ViewModelData.ElmahType.DashboardVM
    {
        ...
        public async Task LoadData(Elmah.ViewModelData.ElmahType.DashboardVMDataOptions[] dataOptions)
        {
            using (var scope = ServiceProvider.CreateScope())
            {
                ...
                if (masterEntityResult.BusinessLogicLayerResponseStatus == Framework.Services.BusinessLogicLayerResponseStatus.MessageOK)
                {
                    ...
                    if(dataOptions == null || dataOptions.Contains(Elmah.ViewModelData.ElmahType.DashboardVMDataOptions.ELMAH_Error))
                    {
                        tasks.Add(Task.Run(async () => {
                        this.CriteriaOfELMAH_Error.Common.Type = new Framework.Queries.QuerySystemStringEqualsCriteria(this.MasterEntity.Type);
                            ...
                            this.ResponseStatuses.Add(resultELMAH_Error.GetStatusMessage<Elmah.ViewModelData.ElmahType.DashboardVMDataOptions>(
                                Elmah.ViewModelData.ElmahType.DashboardVMDataOptions.ELMAH_Error, Framework.Services.BusinessLogicLayerRequestTypes.Search));
