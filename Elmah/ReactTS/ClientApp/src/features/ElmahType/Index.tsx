...
import { getIndex, elmahTypeSelectors } from './Elmah.MvcCore.ClientApp.src.features.Slice';
import { orderBys, ElmahType } from './Elmah.MvcCore.ClientApp.src.features.Types';
import Edit from 'src/components/ElmahType/Elmah.MvcCore.ClientApp.src.components.Edit';
import List from 'src/components/ElmahType/Elmah.MvcCore.ClientApp.src.components.List';
...
export default function IndexPage(): JSX.Element {
  ...
  const { criteria, orderBy, queryPagingSetting } = store.getState().elmahType;
    ...
    <>
      <Paper className={classes.root}>
        <div className={classes.boxHeader}>
          <Typography className={classes.boxHeaderTitle}>{t('Elmah.MvcCore.ClientApp.public.locales.en.UIStringResourcePerApp:ElmahType')}</Typography>
