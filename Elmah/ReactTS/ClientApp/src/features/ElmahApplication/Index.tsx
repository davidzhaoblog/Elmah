...
import { getIndexVM, elmahApplicationSelectors } from './Slice';
import { orderBys, ElmahApplication } from './Types';
import Edit from 'src/components/ElmahApplication/Edit';
import Search from 'src/components/ElmahApplication/Search';
import List from 'src/components/ElmahApplication/List';
...
export default function IndexPage(): JSX.Element {
  ...
  const { commonCriteria, orderBy, queryPagingSetting } = store.getState().elmahApplication;
    ...
    <>
      <Paper className={classes.root}>
        <div className={classes.boxHeader}>
          <Typography className={classes.boxHeaderTitle}>{t('UIStringResourcePerApp:ElmahApplication')}</Typography>
