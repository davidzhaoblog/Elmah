...
import { getIndex, elmahApplicationSelectors } from './Elmah.MvcCore.ClientApp.src.features.Slice';
import { orderBys, ElmahApplication } from './Elmah.MvcCore.ClientApp.src.features.Types';
import Edit from 'src/components/ElmahApplication/Elmah.MvcCore.ClientApp.src.components.Edit';
import List from 'src/components/ElmahApplication/Elmah.MvcCore.ClientApp.src.components.List';
...
export default function IndexPage(): JSX.Element {
  ...
  const { criteria, orderBy, queryPagingSetting } = store.getState().elmahApplication;
  ...
  const listItems = useSelector(
    (state: RootState) => elmahApplicationSelectors.selectAll(state)
  );
    ...
    <>
      <Paper className={classes.root}>
        <div className={classes.boxHeader}>
          <Typography className={classes.boxHeaderTitle}>{t('Elmah.MvcCore.ClientApp.public.locales.en.UIStringResourcePerApp:ElmahApplication')}</Typography>
