...
import Search from 'src/components/ElmahStatusCode/Search';
...
export default function IndexPage(): JSX.Element {
  ...
  const { commonCriteria, orderBy, queryPagingSetting } = store.getState().elmahStatusCode;
  ...
  const openAdvancedSearchInPopup = (type: FormTypes, item: ElmahStatusCode) => {
    setFormType(type);
    ...
    <>
      <Paper className={classes.root}>
        <div className={classes.boxHeader}>
          <Typography className={classes.boxHeaderTitle}>{t('UIStringResourcePerApp:ElmahStatusCode')}</Typography>
