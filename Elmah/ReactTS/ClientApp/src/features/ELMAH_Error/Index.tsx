...
import { getIndex, eLMAH_ErrorSelectors } from './Elmah.MvcCore.ClientApp.src.features.Slice';
import { orderBys, ELMAH_Error } from './Elmah.MvcCore.ClientApp.src.features.Types';
import Edit from 'src/components/ELMAH_Error/Elmah.MvcCore.ClientApp.src.components.Edit';
import List from 'src/components/ELMAH_Error/Elmah.MvcCore.ClientApp.src.components.List';
    ...
    <>
      <Paper className={classes.root}>
        <div className={classes.boxHeader}>
          <Typography className={classes.boxHeaderTitle}>{t('Elmah.MvcCore.ClientApp.public.locales.en.UIStringResourcePerApp:ELMAH_Error')}</Typography>
