...
import { getIndex, elmahUserSelectors } from './Elmah.MvcCore.ClientApp.src.features.Slice';
import { orderBys, ElmahUser } from './Elmah.MvcCore.ClientApp.src.features.Types';
import Edit from 'src/components/ElmahUser/Elmah.MvcCore.ClientApp.src.components.Edit';
import List from 'src/components/ElmahUser/Elmah.MvcCore.ClientApp.src.components.List';
...
export default function IndexPage(): JSX.Element {
  ...
  const listItems = useSelector(
    (state: RootState) => elmahUserSelectors.selectAll(state)
  );
    ...
    <>
      <Paper className={classes.root}>
        <div className={classes.boxHeader}>
          <Typography className={classes.boxHeaderTitle}>{t('Elmah.MvcCore.ClientApp.public.locales.en.UIStringResourcePerApp:ElmahUser')}</Typography>
