...
import { ElmahTypeCommonCriteria } from 'src/features/ElmahType/Types';
import { getIndexVM } from 'src/features/ElmahType/Slice';

export default function Search(props: ISearchFormProps<ElmahTypeCommonCriteria> & IPopupProps) {
