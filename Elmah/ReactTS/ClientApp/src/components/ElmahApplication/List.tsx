  ...
  const { t } = useTranslation(["UIStringResource", "UIStringResourcePerApp"]);
    ...
    const handleDelete = () => {
        ...
        const deleteAlertDialog = {
            ...
            message: 'You are deleting ' + props.item.application,
        ...
        <Accordion key={props.item.application.toString()} expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
            ...
            <AccordionDetails>
                <div className={classes.column}>
                    ...
                    <Typography className={classes.heading} variant="h1" component="h1">{props.item.application}</Typography> class="hidden-sm"
                </div>
            </AccordionDetails>
            <Divider />
            <AccordionActions>
