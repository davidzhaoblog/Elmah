...
import { ElmahStatusCodeCommonCriteria } from 'src/features/ElmahStatusCode/Types';
import { getIndexVM } from 'src/features/ElmahStatusCode/Slice';

export default function Search(props: ISearchFormProps<ElmahStatusCodeCommonCriteria> & IPopupProps) {
