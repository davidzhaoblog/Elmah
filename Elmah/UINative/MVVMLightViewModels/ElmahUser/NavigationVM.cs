...
namespace Elmah.MVVMLightViewModels
{
    public partial class NavigationVM
    {
        ...
        public ElmahUserContainer ElmahUser
        {
            get
            {
                return DependencyService.Resolve<ElmahUserContainer>();
            }
        }

        public partial class ElmahUserContainer : Framework.Xaml.NavigationVMEntityContainer<Elmah.MVVMLightViewModels.ElmahUser.ItemVM, Elmah.DataSourceEntities.ElmahUserIdentifier, Elmah.EntityContracts.IElmahUserIdentifier, Elmah.DataSourceEntities.ElmahUser>
        {
            ...
            public ElmahUserContainer(): base()
            {
                // 3. TabSearchResult/Results/Search/SearchResult
                SearchFormActionSheet = GetSearchFormActionSheet();
            }

            //public ICommand ShowItemBottomUpActionSheetCommand => new Command<Elmah.DataSourceEntities.ElmahUser>(OnShowItemBottomUpActionSheetCommand);

            //private void OnShowItemBottomUpActionSheetCommand(Elmah.DataSourceEntities.ElmahUser item)
            //{
            ...
            //public Framework.Xaml.ActionForm.ActionSheetVM GetItemInlineActionSheet(Elmah.DataSourceEntities.ElmahUser item)
            //{
            //    var selectedActionItemModels = new List<Tuple<Framework.Xaml.StandardRouteRelativeKey, Framework.Xaml.ControlParentOptions>>();
            //
            //    selectedActionItemModels.Add(new Tuple<Framework.Xaml.StandardRouteRelativeKey, Framework.Xaml.ControlParentOptions>(Framework.Xaml.StandardRouteRelativeKey., Framework.Xaml.ControlParentOptions.InPopup));
            ...
            //    Elmah.DataSourceEntities.ElmahUser item
            ...
            public async void OnNavigateToCommand_Create(Elmah.DataSourceEntities.ElmahUser item)
            {
                PopupVM.HidePopup();

                var request = GetLoadDataRequest_NavigateToCommand_Create<Elmah.DataSourceEntities.ElmahUser>(item);
                DetailsFormActionSheetWhenCreate = GetDetailsFormActionSheetWhenCreate(ItemVM);

                MessagingCenter.Send<Elmah.MVVMLightViewModels.ElmahUser.ItemVM, Framework.Xaml.LoadItemDataRequest<Elmah.DataSourceEntities.ElmahUser>>(
                    ItemVM, Elmah.MVVMLightViewModels.ElmahUser.ItemVM.MessageTitle_AssignItem, request);
                await NavigateAsync(DomainKey, Framework.Xaml.StandardRouteRelativeKey.Create.ToString());

                //var parameters = new Dictionary<string, string>();

            //parameters.Add("user", item.User.ToString());
            ...
            */
            ...
            public override void OnShowPopupCommand_Create(Elmah.DataSourceEntities.ElmahUser item)
            {
                PopupVM.HidePopup();

                var request = GetLoadDataRequest_ShowPopupCommand_Create<Elmah.DataSourceEntities.ElmahUser>(item);
                DetailsFormActionSheetWhenCreate = GetDetailsFormActionSheetWhenCreate(ItemVM);
            ...
            {
                ItemVM.DefaultItem = new Elmah.DataSourceEntities.ElmahUser {
            ...
            public async void OnNavigateToCommand_Delete(Elmah.DataSourceEntities.ElmahUser item)
            {
                PopupVM.HidePopup();

                var criteria = new Elmah.DataSourceEntities.ElmahUserIdentifier {
                    User = item.User
                };
                var request = GetLoadDataRequest_NavigateToCommand_Delete<Elmah.DataSourceEntities.ElmahUserIdentifier>(criteria);
                ...
                MessagingCenter.Send<Elmah.MVVMLightViewModels.ElmahUser.ItemVM, Framework.Xaml.LoadItemDataRequest<Elmah.DataSourceEntities.ElmahUserIdentifier>>(
                    ItemVM, Elmah.MVVMLightViewModels.ElmahUser.ItemVM.MessageTitle_LoadItem, request);
            ...
            */
            ...
            /*
            public override void OnShowPopupCommand_Delete(Elmah.DataSourceEntities.ElmahUser item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_ShowPopupCommand_Delete<Elmah.DataSourceEntities.ElmahUserIdentifier>(criteria);
            ...
            */
            ...
            public async void OnNavigateToCommand_Details(Elmah.DataSourceEntities.ElmahUser item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_NavigateToCommand_Details<Elmah.DataSourceEntities.ElmahUserIdentifier>(criteria);
            ...
            */
            ...
            public override async void OnShowPopupCommand_Details(Elmah.DataSourceEntities.ElmahUser item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_ShowPopupCommand_Details<Elmah.DataSourceEntities.ElmahUserIdentifier>(criteria);
                DetailsFormActionSheetWhenReadOnly = GetDetailsFormActionSheetWhenReadOnly(ItemVM);
            ...
            public async void OnNavigateToCommand_Edit(Elmah.DataSourceEntities.ElmahUser item)
            {
                PopupVM.HidePopup();
            ...
            */
            ...
            public override async void OnShowPopupCommand_Edit(Elmah.DataSourceEntities.ElmahUser item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_ShowPopupCommand_Edit<Elmah.DataSourceEntities.ElmahUserIdentifier>(criteria);
                DetailsFormActionSheetWhenEdit = GetDetailsFormActionSheetWhenEdit(ItemVM);
                MessagingCenter.Send<Elmah.MVVMLightViewModels.ElmahUser.ItemVM, Framework.Xaml.LoadItemDataRequest<Elmah.DataSourceEntities.ElmahUserIdentifier>>(
                    ItemVM, Elmah.MVVMLightViewModels.ElmahUser.ItemVM.MessageTitle_LoadItem, request);
            ...
            public void OnNavigateToCommand_Copy(Elmah.DataSourceEntities.ElmahUser item)
            {
                PopupVM.HidePopup();

                var cloned = item.GetAClone<Elmah.DataSourceEntities.ElmahUser>();
                // TODO: set value when copy an item to create a new item, e.g. identifiers to default value.
                cloned.User = default(string);

                var request = GetLoadDataRequest_NavigateToCommand_Copy<Elmah.DataSourceEntities.ElmahUser>(cloned);
                DetailsFormActionSheetWhenCreate = GetDetailsFormActionSheetWhenCreate(ItemVM);
            ...
            */
            ...
            /*
            public override void OnShowPopupCommand_Copy(Elmah.DataSourceEntities.ElmahUser item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_ShowPopupCommand_Copy<Elmah.DataSourceEntities.ElmahUser>(cloned);
                DetailsFormActionSheetWhenCreate = GetDetailsFormActionSheetWhenCreate(ItemVM);
            ...
            */
            ...
            protected virtual Framework.Xaml.ActionForm.ActionSheetVM GetListFooterActionSheet(Elmah.MVVMLightViewModels.ElmahUser.IndexVM vm)
            {
            ...
            protected override void OnShowListFullScreenActionSheetCommand()
            {
                ...
                var vm = DependencyService.Resolve<Elmah.MVVMLightViewModels.ElmahUser.IndexVM>();
...
/*
                ...
                , Framework.Queries.QueryOrderDirections? orderByDirection)
            {
                var actionItem = new Framework.Xaml.ActionForm.ActionItemModel
                {
                    ...
                    Title = Elmah.Resx.UIStringResourcePerApp.ElmahUser, // some localized text here, e.g. Framework.Resx.UIStringResource. or NTierOnTime.Resx.UIStringResourcePerApp, or NTierOnTime.Resx.UIStringResourcePerEntity
            ...
            {
                var vm = DependencyService.Resolve<Elmah.MVVMLightViewModels.ElmahUser.IndexVM>();
                MessagingCenter.Send<Elmah.MVVMLightViewModels.ElmahUser.IndexVM, Framework.Xaml.LoadListDataRequest>(vm, Elmah.MVVMLightViewModels.ElmahUser.IndexVM.MessageTitle_LoadData,
                    new Framework.Xaml.LoadListDataRequest
                    {
                        ...
                        , Parameters = new Dictionary<string, object> {
                                    { nameof(Elmah.DataSourceEntities.ElmahUser.oneCondition), oneCondition },
                                    // { nameof(Elmah.DataSourceEntities.ElmahUser.BusinessEntityID), businessEntityID }, // can be more
                        }
...
*/
            ...
            // 7. override methods
            /*
            protected override Framework.Xaml.ActionForm.ActionItemModel GetSwitchToEditActionItemModel(Elmah.MVVMLightViewModels.ElmahUser.ItemVM itemVM)
            {
