...
namespace Elmah.MVVMLightViewModels
{
    public partial class NavigationVM
    {
        ...
        public ELMAH_ErrorContainer ELMAH_Error
        {
            get
            {
                return DependencyService.Resolve<ELMAH_ErrorContainer>();
            }
        }

        public partial class ELMAH_ErrorContainer : Framework.Xaml.NavigationVMEntityContainer<Elmah.MVVMLightViewModels.ELMAH_Error.ItemVM, Elmah.DataSourceEntities.ELMAH_ErrorIdentifier, Elmah.EntityContracts.IELMAH_ErrorIdentifier, Elmah.DataSourceEntities.ELMAH_Error.Default>
        {

            public const string DomainKey = "ELMAH_Error";
            ...
            public ELMAH_ErrorContainer(): base()
            {
                // 3. TabSearchResult/Results/Search/SearchResult
                SearchFormActionSheet = GetSearchFormActionSheet();
            }

            //public ICommand ShowItemBottomUpActionSheetCommand => new Command<Elmah.DataSourceEntities.ELMAH_Error.Default>(OnShowItemBottomUpActionSheetCommand);

            //private void OnShowItemBottomUpActionSheetCommand(Elmah.DataSourceEntities.ELMAH_Error.Default item)
            //{
            ...
            //public Framework.Xaml.ActionForm.ActionSheetVM GetItemInlineActionSheet(Elmah.DataSourceEntities.ELMAH_Error.Default item)
            //{
            //    var selectedActionItemModels = new List<Tuple<Framework.Xaml.StandardRouteRelativeKey, Framework.Xaml.ControlParentOptions>>();
            //
            //    selectedActionItemModels.Add(new Tuple<Framework.Xaml.StandardRouteRelativeKey, Framework.Xaml.ControlParentOptions>(Framework.Xaml.StandardRouteRelativeKey., Framework.Xaml.ControlParentOptions.InPopup));
            ...
            //    Elmah.DataSourceEntities.ELMAH_Error.Default item
            ...
            public async void OnNavigateToCommand_Create(Elmah.DataSourceEntities.ELMAH_Error.Default item)
            {
                PopupVM.HidePopup();

                var request = GetLoadDataRequest_NavigateToCommand_Create<Elmah.DataSourceEntities.ELMAH_Error.Default>(item);
                DetailsFormActionSheetWhenCreate = GetDetailsFormActionSheetWhenCreate(ItemVM);

                MessagingCenter.Send<Elmah.MVVMLightViewModels.ELMAH_Error.ItemVM, Framework.Xaml.LoadItemDataRequest<Elmah.DataSourceEntities.ELMAH_Error.Default>>(
                    ItemVM, Elmah.MVVMLightViewModels.ELMAH_Error.ItemVM.MessageTitle_AssignItem, request);
                await NavigateAsync(DomainKey, Framework.Xaml.StandardRouteRelativeKey.Create.ToString());

                //var parameters = new Dictionary<string, string>();

            //parameters.Add("errorid", item.ErrorId.ToString());

            //parameters.Add("sequence", item.Sequence.ToString());
            ...
            */
            ...
            public override void OnShowPopupCommand_Create(Elmah.DataSourceEntities.ELMAH_Error.Default item)
            {
                PopupVM.HidePopup();

                var request = GetLoadDataRequest_ShowPopupCommand_Create<Elmah.DataSourceEntities.ELMAH_Error.Default>(item);
                DetailsFormActionSheetWhenCreate = GetDetailsFormActionSheetWhenCreate(ItemVM);
            ...
            public async void OnNavigateToCommand_Delete(Elmah.DataSourceEntities.ELMAH_Error.Default item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_NavigateToCommand_Delete<Elmah.DataSourceEntities.ELMAH_ErrorIdentifier>(criteria);
                ...
                MessagingCenter.Send<Elmah.MVVMLightViewModels.ELMAH_Error.ItemVM, Framework.Xaml.LoadItemDataRequest<Elmah.DataSourceEntities.ELMAH_ErrorIdentifier>>(
                    ItemVM, Elmah.MVVMLightViewModels.ELMAH_Error.ItemVM.MessageTitle_LoadItem, request);
            ...
            */
            ...
            /*
            public override void OnShowPopupCommand_Delete(Elmah.DataSourceEntities.ELMAH_Error.Default item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_ShowPopupCommand_Delete<Elmah.DataSourceEntities.ELMAH_ErrorIdentifier>(criteria);
            ...
            */
            ...
            public async void OnNavigateToCommand_Details(Elmah.DataSourceEntities.ELMAH_Error.Default item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_NavigateToCommand_Details<Elmah.DataSourceEntities.ELMAH_ErrorIdentifier>(criteria);
            ...
            */
            ...
            public override async void OnShowPopupCommand_Details(Elmah.DataSourceEntities.ELMAH_Error.Default item)
            {
                PopupVM.HidePopup();
            ...
            public async void OnNavigateToCommand_Edit(Elmah.DataSourceEntities.ELMAH_Error.Default item)
            {
                PopupVM.HidePopup();
            ...
            */
            ...
            public override async void OnShowPopupCommand_Edit(Elmah.DataSourceEntities.ELMAH_Error.Default item)
            {
                PopupVM.HidePopup();
            ...
            public void OnNavigateToCommand_Copy(Elmah.DataSourceEntities.ELMAH_Error.Default item)
            {
                PopupVM.HidePopup();

                var cloned = item.GetAClone<Elmah.DataSourceEntities.ELMAH_Error.Default>();
                // TODO: set value when copy an item to create a new item, e.g. identifiers to default value.
                cloned.ErrorId = default(System.Guid); cloned.Sequence = default(int);

                var request = GetLoadDataRequest_NavigateToCommand_Copy<Elmah.DataSourceEntities.ELMAH_Error.Default>(cloned);
                DetailsFormActionSheetWhenCreate = GetDetailsFormActionSheetWhenCreate(ItemVM);
            ...
            */
            ...
            /*
            public override void OnShowPopupCommand_Copy(Elmah.DataSourceEntities.ELMAH_Error.Default item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_ShowPopupCommand_Copy<Elmah.DataSourceEntities.ELMAH_Error.Default>(cloned);
                DetailsFormActionSheetWhenCreate = GetDetailsFormActionSheetWhenCreate(ItemVM);
            ...
            */
            ...
            protected virtual Framework.Xaml.ActionForm.ActionSheetVM GetListFooterActionSheet(Elmah.MVVMLightViewModels.ELMAH_Error.IndexVM vm)
            {
            ...
            protected override void OnShowListFullScreenActionSheetCommand()
            {
                ...
                var vm = DependencyService.Resolve<Elmah.MVVMLightViewModels.ELMAH_Error.IndexVM>();
            ...
            */
            ...
            // 03.01. CommonSearchView -> Elmah.XamarinForms.Pages.ELMAH_Error.CommonSearchView
/*
            ...
            {
                var vm = DependencyService.Resolve<Elmah.MVVMLightViewModels.ELMAH_Error.IndexVM>();
                MessagingCenter.Send<Elmah.MVVMLightViewModels.ELMAH_Error.IndexVM, Framework.Xaml.LoadListDataRequest>(vm, Elmah.MVVMLightViewModels.ELMAH_Error.IndexVM.MessageTitle_LoadData,
...
*/
            ...
            // 7. override methods
            /*
            protected override Framework.Xaml.ActionForm.ActionItemModel GetSwitchToEditActionItemModel(Elmah.MVVMLightViewModels.ELMAH_Error.ItemVM itemVM)
            {
