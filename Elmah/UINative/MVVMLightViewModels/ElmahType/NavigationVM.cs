...
namespace Elmah.MVVMLightViewModels
{
    public partial class NavigationVM
    {
        ...
        public ElmahTypeContainer ElmahType
        {
            get
            {
                return DependencyService.Resolve<ElmahTypeContainer>();
            }
        }

        public partial class ElmahTypeContainer : Framework.Xaml.NavigationVMEntityContainer<Elmah.MVVMLightViewModels.ElmahType.ItemVM, Elmah.DataSourceEntities.ElmahTypeIdentifier, Elmah.EntityContracts.IElmahTypeIdentifier, Elmah.DataSourceEntities.ElmahType>
        {

            public const string DomainKey = "ElmahType";
            ...
            public ElmahTypeContainer(): base()
            {
            ...
            */
            ...
            public async void OnNavigateToCommand_Delete(Elmah.DataSourceEntities.ElmahType item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_NavigateToCommand_Delete<Elmah.DataSourceEntities.ElmahTypeIdentifier>(criteria);
            ...
            */
            ...
            /*
            public override void OnShowPopupCommand_Delete(Elmah.DataSourceEntities.ElmahType item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_ShowPopupCommand_Delete<Elmah.DataSourceEntities.ElmahTypeIdentifier>(criteria);
            ...
            */
            ...
            public async void OnNavigateToCommand_Details(Elmah.DataSourceEntities.ElmahType item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_NavigateToCommand_Details<Elmah.DataSourceEntities.ElmahTypeIdentifier>(criteria);
            ...
            */
            ...
            public override async void OnShowPopupCommand_Details(Elmah.DataSourceEntities.ElmahType item)
            {
                PopupVM.HidePopup();
            ...
            */
            ...
            public void OnNavigateToCommand_Copy(Elmah.DataSourceEntities.ElmahType item)
            {
                PopupVM.HidePopup();

                var cloned = item.GetAClone<Elmah.DataSourceEntities.ElmahType>();
                // TODO: set value when copy an item to create a new item, e.g. identifiers to default value.
                cloned.Type = default(string);

                var request = GetLoadDataRequest_NavigateToCommand_Copy<Elmah.DataSourceEntities.ElmahType>(cloned);
                DetailsFormActionSheetWhenCreate = GetDetailsFormActionSheetWhenCreate(ItemVM);
            ...
            */
            ...
            /*
            public override void OnShowPopupCommand_Copy(Elmah.DataSourceEntities.ElmahType item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_ShowPopupCommand_Copy<Elmah.DataSourceEntities.ElmahType>(cloned);
                DetailsFormActionSheetWhenCreate = GetDetailsFormActionSheetWhenCreate(ItemVM);
            ...
            */
            ...
            protected virtual Framework.Xaml.ActionForm.ActionSheetVM GetListFooterActionSheet(Elmah.MVVMLightViewModels.ElmahType.IndexVM vm)
            {
...
*/
            ...
            // 7. override methods
            /*
            protected override Framework.Xaml.ActionForm.ActionItemModel GetSwitchToEditActionItemModel(Elmah.MVVMLightViewModels.ElmahType.ItemVM itemVM)
            {
