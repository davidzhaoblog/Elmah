...
namespace Elmah.MVVMLightViewModels
{
    public partial class NavigationVM
    {
        ...
        public ElmahHostContainer ElmahHost
        {
            get
            {
                return DependencyService.Resolve<ElmahHostContainer>();
            }
        }

        public partial class ElmahHostContainer : Framework.Xaml.NavigationVMEntityContainer<Elmah.MVVMLightViewModels.ElmahHost.ItemVM, Elmah.DataSourceEntities.ElmahHostIdentifier, Elmah.EntityContracts.IElmahHostIdentifier, Elmah.DataSourceEntities.ElmahHost>
        {
            ...
            public ElmahHostContainer(): base()
            {
                // 3. TabSearchResult/Results/Search/SearchResult
                SearchFormActionSheet = GetSearchFormActionSheet();
            }

            //public ICommand ShowItemBottomUpActionSheetCommand => new Command<Elmah.DataSourceEntities.ElmahHost>(OnShowItemBottomUpActionSheetCommand);

            //private void OnShowItemBottomUpActionSheetCommand(Elmah.DataSourceEntities.ElmahHost item)
            //{
            ...
            //public Framework.Xaml.ActionForm.ActionSheetVM GetItemInlineActionSheet(Elmah.DataSourceEntities.ElmahHost item)
            //{
            //    var selectedActionItemModels = new List<Tuple<Framework.Xaml.StandardRouteRelativeKey, Framework.Xaml.ControlParentOptions>>();
            //
            //    selectedActionItemModels.Add(new Tuple<Framework.Xaml.StandardRouteRelativeKey, Framework.Xaml.ControlParentOptions>(Framework.Xaml.StandardRouteRelativeKey., Framework.Xaml.ControlParentOptions.InPopup));
            ...
            //    Elmah.DataSourceEntities.ElmahHost item
            ...
            public async void OnNavigateToCommand_Create(Elmah.DataSourceEntities.ElmahHost item)
            {
                PopupVM.HidePopup();

                var request = GetLoadDataRequest_NavigateToCommand_Create<Elmah.DataSourceEntities.ElmahHost>(item);
                DetailsFormActionSheetWhenCreate = GetDetailsFormActionSheetWhenCreate(ItemVM);

                MessagingCenter.Send<Elmah.MVVMLightViewModels.ElmahHost.ItemVM, Framework.Xaml.LoadItemDataRequest<Elmah.DataSourceEntities.ElmahHost>>(
                    ItemVM, Elmah.MVVMLightViewModels.ElmahHost.ItemVM.MessageTitle_AssignItem, request);
                await NavigateAsync(DomainKey, Framework.Xaml.StandardRouteRelativeKey.Create.ToString());

                //var parameters = new Dictionary<string, string>();

            //parameters.Add("host", item.Host.ToString());
            ...
            */
            ...
            public override void OnShowPopupCommand_Create(Elmah.DataSourceEntities.ElmahHost item)
            {
                PopupVM.HidePopup();

                var request = GetLoadDataRequest_ShowPopupCommand_Create<Elmah.DataSourceEntities.ElmahHost>(item);
                DetailsFormActionSheetWhenCreate = GetDetailsFormActionSheetWhenCreate(ItemVM);
            ...
            {
                ItemVM.DefaultItem = new Elmah.DataSourceEntities.ElmahHost {
            ...
            public async void OnNavigateToCommand_Delete(Elmah.DataSourceEntities.ElmahHost item)
            {
                PopupVM.HidePopup();

                var criteria = new Elmah.DataSourceEntities.ElmahHostIdentifier {
                    Host = item.Host
                };
                var request = GetLoadDataRequest_NavigateToCommand_Delete<Elmah.DataSourceEntities.ElmahHostIdentifier>(criteria);
                ...
                MessagingCenter.Send<Elmah.MVVMLightViewModels.ElmahHost.ItemVM, Framework.Xaml.LoadItemDataRequest<Elmah.DataSourceEntities.ElmahHostIdentifier>>(
                    ItemVM, Elmah.MVVMLightViewModels.ElmahHost.ItemVM.MessageTitle_LoadItem, request);
            ...
            */
            ...
            /*
            public override void OnShowPopupCommand_Delete(Elmah.DataSourceEntities.ElmahHost item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_ShowPopupCommand_Delete<Elmah.DataSourceEntities.ElmahHostIdentifier>(criteria);
            ...
            */
            ...
            public async void OnNavigateToCommand_Details(Elmah.DataSourceEntities.ElmahHost item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_NavigateToCommand_Details<Elmah.DataSourceEntities.ElmahHostIdentifier>(criteria);
            ...
            */
            ...
            public override async void OnShowPopupCommand_Details(Elmah.DataSourceEntities.ElmahHost item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_ShowPopupCommand_Details<Elmah.DataSourceEntities.ElmahHostIdentifier>(criteria);
                DetailsFormActionSheetWhenReadOnly = GetDetailsFormActionSheetWhenReadOnly(ItemVM);
            ...
            public async void OnNavigateToCommand_Edit(Elmah.DataSourceEntities.ElmahHost item)
            {
                PopupVM.HidePopup();
            ...
            */
            ...
            public override async void OnShowPopupCommand_Edit(Elmah.DataSourceEntities.ElmahHost item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_ShowPopupCommand_Edit<Elmah.DataSourceEntities.ElmahHostIdentifier>(criteria);
                DetailsFormActionSheetWhenEdit = GetDetailsFormActionSheetWhenEdit(ItemVM);
                MessagingCenter.Send<Elmah.MVVMLightViewModels.ElmahHost.ItemVM, Framework.Xaml.LoadItemDataRequest<Elmah.DataSourceEntities.ElmahHostIdentifier>>(
                    ItemVM, Elmah.MVVMLightViewModels.ElmahHost.ItemVM.MessageTitle_LoadItem, request);
            ...
            public void OnNavigateToCommand_Copy(Elmah.DataSourceEntities.ElmahHost item)
            {
                PopupVM.HidePopup();

                var cloned = item.GetAClone<Elmah.DataSourceEntities.ElmahHost>();
                // TODO: set value when copy an item to create a new item, e.g. identifiers to default value.
                cloned.Host = default(string);

                var request = GetLoadDataRequest_NavigateToCommand_Copy<Elmah.DataSourceEntities.ElmahHost>(cloned);
                DetailsFormActionSheetWhenCreate = GetDetailsFormActionSheetWhenCreate(ItemVM);
            ...
            */
            ...
            /*
            public override void OnShowPopupCommand_Copy(Elmah.DataSourceEntities.ElmahHost item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_ShowPopupCommand_Copy<Elmah.DataSourceEntities.ElmahHost>(cloned);
                DetailsFormActionSheetWhenCreate = GetDetailsFormActionSheetWhenCreate(ItemVM);
            ...
            */
            ...
            protected virtual Framework.Xaml.ActionForm.ActionSheetVM GetListFooterActionSheet(Elmah.MVVMLightViewModels.ElmahHost.IndexVM vm)
            {
            ...
            protected override void OnShowListFullScreenActionSheetCommand()
            {
                ...
                var vm = DependencyService.Resolve<Elmah.MVVMLightViewModels.ElmahHost.IndexVM>();
...
/*
                ...
                , Framework.Queries.QueryOrderDirections? orderByDirection)
            {
                var actionItem = new Framework.Xaml.ActionForm.ActionItemModel
                {
                    ...
                    Title = Elmah.Resx.UIStringResourcePerApp.ElmahHost, // some localized text here, e.g. Framework.Resx.UIStringResource. or NTierOnTime.Resx.UIStringResourcePerApp, or NTierOnTime.Resx.UIStringResourcePerEntity
            ...
            {
                var vm = DependencyService.Resolve<Elmah.MVVMLightViewModels.ElmahHost.IndexVM>();
                MessagingCenter.Send<Elmah.MVVMLightViewModels.ElmahHost.IndexVM, Framework.Xaml.LoadListDataRequest>(vm, Elmah.MVVMLightViewModels.ElmahHost.IndexVM.MessageTitle_LoadData,
                    new Framework.Xaml.LoadListDataRequest
                    {
                        ...
                        , Parameters = new Dictionary<string, object> {
                                    { nameof(Elmah.DataSourceEntities.ElmahHost.oneCondition), oneCondition },
                                    // { nameof(Elmah.DataSourceEntities.ElmahHost.BusinessEntityID), businessEntityID }, // can be more
                        }
...
*/
            ...
            // 7. override methods
            /*
            protected override Framework.Xaml.ActionForm.ActionItemModel GetSwitchToEditActionItemModel(Elmah.MVVMLightViewModels.ElmahHost.ItemVM itemVM)
            {
