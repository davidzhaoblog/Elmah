...
namespace Elmah.MVVMLightViewModels
{
    public partial class NavigationVM
    {
        ...
        public ElmahSourceContainer ElmahSource
        {
            get
            {
                return DependencyService.Resolve<ElmahSourceContainer>();
            }
        }

        public partial class ElmahSourceContainer : Framework.Xaml.NavigationVMEntityContainer<Elmah.MVVMLightViewModels.ElmahSource.ItemVM, Elmah.DataSourceEntities.ElmahSourceIdentifier, Elmah.EntityContracts.IElmahSourceIdentifier, Elmah.DataSourceEntities.ElmahSource>
        {
            ...
            public ElmahSourceContainer(): base()
            {
                // 3. TabSearchResult/Results/Search/SearchResult
                SearchFormActionSheet = GetSearchFormActionSheet();
            }

            //public ICommand ShowItemBottomUpActionSheetCommand => new Command<Elmah.DataSourceEntities.ElmahSource>(OnShowItemBottomUpActionSheetCommand);

            //private void OnShowItemBottomUpActionSheetCommand(Elmah.DataSourceEntities.ElmahSource item)
            //{
            ...
            //public Framework.Xaml.ActionForm.ActionSheetVM GetItemInlineActionSheet(Elmah.DataSourceEntities.ElmahSource item)
            //{
            //    var selectedActionItemModels = new List<Tuple<Framework.Xaml.StandardRouteRelativeKey, Framework.Xaml.ControlParentOptions>>();
            //
            //    selectedActionItemModels.Add(new Tuple<Framework.Xaml.StandardRouteRelativeKey, Framework.Xaml.ControlParentOptions>(Framework.Xaml.StandardRouteRelativeKey., Framework.Xaml.ControlParentOptions.InPopup));
            ...
            //    Elmah.DataSourceEntities.ElmahSource item
            ...
            public async void OnNavigateToCommand_Create(Elmah.DataSourceEntities.ElmahSource item)
            {
                PopupVM.HidePopup();

                var request = GetLoadDataRequest_NavigateToCommand_Create<Elmah.DataSourceEntities.ElmahSource>(item);
                DetailsFormActionSheetWhenCreate = GetDetailsFormActionSheetWhenCreate(ItemVM);

                MessagingCenter.Send<Elmah.MVVMLightViewModels.ElmahSource.ItemVM, Framework.Xaml.LoadItemDataRequest<Elmah.DataSourceEntities.ElmahSource>>(
                    ItemVM, Elmah.MVVMLightViewModels.ElmahSource.ItemVM.MessageTitle_AssignItem, request);
                await NavigateAsync(DomainKey, Framework.Xaml.StandardRouteRelativeKey.Create.ToString());

                //var parameters = new Dictionary<string, string>();

            //parameters.Add("source", item.Source.ToString());
            ...
            */
            ...
            public override void OnShowPopupCommand_Create(Elmah.DataSourceEntities.ElmahSource item)
            {
                PopupVM.HidePopup();

                var request = GetLoadDataRequest_ShowPopupCommand_Create<Elmah.DataSourceEntities.ElmahSource>(item);
                DetailsFormActionSheetWhenCreate = GetDetailsFormActionSheetWhenCreate(ItemVM);
            ...
            {
                ItemVM.DefaultItem = new Elmah.DataSourceEntities.ElmahSource {
                };
            }
            ...
            public async void OnNavigateToCommand_Delete(Elmah.DataSourceEntities.ElmahSource item)
            {
                PopupVM.HidePopup();

                var criteria = new Elmah.DataSourceEntities.ElmahSourceIdentifier {
                    Source = item.Source
                };
                var request = GetLoadDataRequest_NavigateToCommand_Delete<Elmah.DataSourceEntities.ElmahSourceIdentifier>(criteria);
                ...
                MessagingCenter.Send<Elmah.MVVMLightViewModels.ElmahSource.ItemVM, Framework.Xaml.LoadItemDataRequest<Elmah.DataSourceEntities.ElmahSourceIdentifier>>(
                    ItemVM, Elmah.MVVMLightViewModels.ElmahSource.ItemVM.MessageTitle_LoadItem, request);
            ...
            */
            ...
            /*
            public override void OnShowPopupCommand_Delete(Elmah.DataSourceEntities.ElmahSource item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_ShowPopupCommand_Delete<Elmah.DataSourceEntities.ElmahSourceIdentifier>(criteria);
            ...
            */
            ...
            public async void OnNavigateToCommand_Details(Elmah.DataSourceEntities.ElmahSource item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_NavigateToCommand_Details<Elmah.DataSourceEntities.ElmahSourceIdentifier>(criteria);
            ...
            */
            ...
            public override async void OnShowPopupCommand_Details(Elmah.DataSourceEntities.ElmahSource item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_ShowPopupCommand_Details<Elmah.DataSourceEntities.ElmahSourceIdentifier>(criteria);
                DetailsFormActionSheetWhenReadOnly = GetDetailsFormActionSheetWhenReadOnly(ItemVM);
            ...
            public async void OnNavigateToCommand_Edit(Elmah.DataSourceEntities.ElmahSource item)
            {
                PopupVM.HidePopup();
            ...
            */
            ...
            public override async void OnShowPopupCommand_Edit(Elmah.DataSourceEntities.ElmahSource item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_ShowPopupCommand_Edit<Elmah.DataSourceEntities.ElmahSourceIdentifier>(criteria);
                DetailsFormActionSheetWhenEdit = GetDetailsFormActionSheetWhenEdit(ItemVM);
                MessagingCenter.Send<Elmah.MVVMLightViewModels.ElmahSource.ItemVM, Framework.Xaml.LoadItemDataRequest<Elmah.DataSourceEntities.ElmahSourceIdentifier>>(
                    ItemVM, Elmah.MVVMLightViewModels.ElmahSource.ItemVM.MessageTitle_LoadItem, request);
            ...
            public void OnNavigateToCommand_Copy(Elmah.DataSourceEntities.ElmahSource item)
            {
                PopupVM.HidePopup();

                var cloned = item.GetAClone<Elmah.DataSourceEntities.ElmahSource>();
                // TODO: set value when copy an item to create a new item, e.g. identifiers to default value.
                cloned.Source = default(string);

                var request = GetLoadDataRequest_NavigateToCommand_Copy<Elmah.DataSourceEntities.ElmahSource>(cloned);
                DetailsFormActionSheetWhenCreate = GetDetailsFormActionSheetWhenCreate(ItemVM);
            ...
            */
            ...
            /*
            public override void OnShowPopupCommand_Copy(Elmah.DataSourceEntities.ElmahSource item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_ShowPopupCommand_Copy<Elmah.DataSourceEntities.ElmahSource>(cloned);
                DetailsFormActionSheetWhenCreate = GetDetailsFormActionSheetWhenCreate(ItemVM);
            ...
            */
            ...
            protected virtual Framework.Xaml.ActionForm.ActionSheetVM GetListFooterActionSheet(Elmah.MVVMLightViewModels.ElmahSource.IndexVM vm)
            {
            ...
            protected override void OnShowListFullScreenActionSheetCommand()
            {
                ...
                var vm = DependencyService.Resolve<Elmah.MVVMLightViewModels.ElmahSource.IndexVM>();
...
/*
                ...
                , Framework.Queries.QueryOrderDirections? orderByDirection)
            {
                var actionItem = new Framework.Xaml.ActionForm.ActionItemModel
                {
                    ...
                    Title = Elmah.Resx.UIStringResourcePerApp.ElmahSource, // some localized text here, e.g. Framework.Resx.UIStringResource. or NTierOnTime.Resx.UIStringResourcePerApp, or NTierOnTime.Resx.UIStringResourcePerEntity
            ...
            {
                var vm = DependencyService.Resolve<Elmah.MVVMLightViewModels.ElmahSource.IndexVM>();
                MessagingCenter.Send<Elmah.MVVMLightViewModels.ElmahSource.IndexVM, Framework.Xaml.LoadListDataRequest>(vm, Elmah.MVVMLightViewModels.ElmahSource.IndexVM.MessageTitle_LoadData,
                    new Framework.Xaml.LoadListDataRequest
                    {
                        ...
                        , Parameters = new Dictionary<string, object> {
                                    { nameof(Elmah.DataSourceEntities.ElmahSource.oneCondition), oneCondition },
                                    // { nameof(Elmah.DataSourceEntities.ElmahSource.BusinessEntityID), businessEntityID }, // can be more
                        }
...
*/
            ...
            // 7. override methods
            /*
            protected override Framework.Xaml.ActionForm.ActionItemModel GetSwitchToEditActionItemModel(Elmah.MVVMLightViewModels.ElmahSource.ItemVM itemVM)
            {
