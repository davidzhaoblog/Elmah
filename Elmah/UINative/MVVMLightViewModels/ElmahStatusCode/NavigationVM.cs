...
namespace Elmah.MVVMLightViewModels
{
    public partial class NavigationVM
    {
        ...
        public ElmahStatusCodeContainer ElmahStatusCode
        {
            get
            {
                return DependencyService.Resolve<ElmahStatusCodeContainer>();
            }
        }

        public partial class ElmahStatusCodeContainer : Framework.Xaml.NavigationVMEntityContainer<Elmah.MVVMLightViewModels.ElmahStatusCode.ItemVM, Elmah.DataSourceEntities.ElmahStatusCodeIdentifier, Elmah.EntityContracts.IElmahStatusCodeIdentifier, Elmah.DataSourceEntities.ElmahStatusCode>
        {
            ...
            public ElmahStatusCodeContainer(): base()
            {
                // 3. TabSearchResult/Results/Search/SearchResult
                SearchFormActionSheet = GetSearchFormActionSheet();
            }

            //public ICommand ShowItemBottomUpActionSheetCommand => new Command<Elmah.DataSourceEntities.ElmahStatusCode>(OnShowItemBottomUpActionSheetCommand);

            //private void OnShowItemBottomUpActionSheetCommand(Elmah.DataSourceEntities.ElmahStatusCode item)
            //{
            ...
            //public Framework.Xaml.ActionForm.ActionSheetVM GetItemInlineActionSheet(Elmah.DataSourceEntities.ElmahStatusCode item)
            //{
            //    var selectedActionItemModels = new List<Tuple<Framework.Xaml.StandardRouteRelativeKey, Framework.Xaml.ControlParentOptions>>();
            //
            //    selectedActionItemModels.Add(new Tuple<Framework.Xaml.StandardRouteRelativeKey, Framework.Xaml.ControlParentOptions>(Framework.Xaml.StandardRouteRelativeKey., Framework.Xaml.ControlParentOptions.InPopup));
            ...
            //    Elmah.DataSourceEntities.ElmahStatusCode item
            ...
            public async void OnNavigateToCommand_Create(Elmah.DataSourceEntities.ElmahStatusCode item)
            {
                PopupVM.HidePopup();

                var request = GetLoadDataRequest_NavigateToCommand_Create<Elmah.DataSourceEntities.ElmahStatusCode>(item);
                DetailsFormActionSheetWhenCreate = GetDetailsFormActionSheetWhenCreate(ItemVM);

                MessagingCenter.Send<Elmah.MVVMLightViewModels.ElmahStatusCode.ItemVM, Framework.Xaml.LoadItemDataRequest<Elmah.DataSourceEntities.ElmahStatusCode>>(
                    ItemVM, Elmah.MVVMLightViewModels.ElmahStatusCode.ItemVM.MessageTitle_AssignItem, request);
                await NavigateAsync(DomainKey, Framework.Xaml.StandardRouteRelativeKey.Create.ToString());

                //var parameters = new Dictionary<string, string>();

            //parameters.Add("statuscode", item.StatusCode.ToString());
            ...
            */
            ...
            public override void OnShowPopupCommand_Create(Elmah.DataSourceEntities.ElmahStatusCode item)
            {
                PopupVM.HidePopup();

                var request = GetLoadDataRequest_ShowPopupCommand_Create<Elmah.DataSourceEntities.ElmahStatusCode>(item);
                DetailsFormActionSheetWhenCreate = GetDetailsFormActionSheetWhenCreate(ItemVM);
            ...
            {
                ItemVM.DefaultItem = new Elmah.DataSourceEntities.ElmahStatusCode {
            ...
            public async void OnNavigateToCommand_Delete(Elmah.DataSourceEntities.ElmahStatusCode item)
            {
                PopupVM.HidePopup();

                var criteria = new Elmah.DataSourceEntities.ElmahStatusCodeIdentifier {
                    StatusCode = item.StatusCode
                };
                var request = GetLoadDataRequest_NavigateToCommand_Delete<Elmah.DataSourceEntities.ElmahStatusCodeIdentifier>(criteria);
                ...
                MessagingCenter.Send<Elmah.MVVMLightViewModels.ElmahStatusCode.ItemVM, Framework.Xaml.LoadItemDataRequest<Elmah.DataSourceEntities.ElmahStatusCodeIdentifier>>(
                    ItemVM, Elmah.MVVMLightViewModels.ElmahStatusCode.ItemVM.MessageTitle_LoadItem, request);
            ...
            */
            ...
            /*
            public override void OnShowPopupCommand_Delete(Elmah.DataSourceEntities.ElmahStatusCode item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_ShowPopupCommand_Delete<Elmah.DataSourceEntities.ElmahStatusCodeIdentifier>(criteria);
            ...
            */
            ...
            public async void OnNavigateToCommand_Details(Elmah.DataSourceEntities.ElmahStatusCode item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_NavigateToCommand_Details<Elmah.DataSourceEntities.ElmahStatusCodeIdentifier>(criteria);
            ...
            */
            ...
            public override async void OnShowPopupCommand_Details(Elmah.DataSourceEntities.ElmahStatusCode item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_ShowPopupCommand_Details<Elmah.DataSourceEntities.ElmahStatusCodeIdentifier>(criteria);
                DetailsFormActionSheetWhenReadOnly = GetDetailsFormActionSheetWhenReadOnly(ItemVM);
            ...
            public async void OnNavigateToCommand_Edit(Elmah.DataSourceEntities.ElmahStatusCode item)
            {
                PopupVM.HidePopup();
            ...
            */
            ...
            public override async void OnShowPopupCommand_Edit(Elmah.DataSourceEntities.ElmahStatusCode item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_ShowPopupCommand_Edit<Elmah.DataSourceEntities.ElmahStatusCodeIdentifier>(criteria);
                DetailsFormActionSheetWhenEdit = GetDetailsFormActionSheetWhenEdit(ItemVM);
                MessagingCenter.Send<Elmah.MVVMLightViewModels.ElmahStatusCode.ItemVM, Framework.Xaml.LoadItemDataRequest<Elmah.DataSourceEntities.ElmahStatusCodeIdentifier>>(
                    ItemVM, Elmah.MVVMLightViewModels.ElmahStatusCode.ItemVM.MessageTitle_LoadItem, request);
            ...
            public void OnNavigateToCommand_Copy(Elmah.DataSourceEntities.ElmahStatusCode item)
            {
                PopupVM.HidePopup();

                var cloned = item.GetAClone<Elmah.DataSourceEntities.ElmahStatusCode>();
                // TODO: set value when copy an item to create a new item, e.g. identifiers to default value.
                cloned.StatusCode = default(int);

                var request = GetLoadDataRequest_NavigateToCommand_Copy<Elmah.DataSourceEntities.ElmahStatusCode>(cloned);
                DetailsFormActionSheetWhenCreate = GetDetailsFormActionSheetWhenCreate(ItemVM);
            ...
            */
            ...
            /*
            public override void OnShowPopupCommand_Copy(Elmah.DataSourceEntities.ElmahStatusCode item)
            {
                PopupVM.HidePopup();
                ...
                var request = GetLoadDataRequest_ShowPopupCommand_Copy<Elmah.DataSourceEntities.ElmahStatusCode>(cloned);
                DetailsFormActionSheetWhenCreate = GetDetailsFormActionSheetWhenCreate(ItemVM);
            ...
            */
            ...
            protected virtual Framework.Xaml.ActionForm.ActionSheetVM GetListFooterActionSheet(Elmah.MVVMLightViewModels.ElmahStatusCode.IndexVM vm)
            {
            ...
            protected override void OnShowListFullScreenActionSheetCommand()
            {
                ...
                var vm = DependencyService.Resolve<Elmah.MVVMLightViewModels.ElmahStatusCode.IndexVM>();
...
/*
                ...
                , Framework.Queries.QueryOrderDirections? orderByDirection)
            {
                var actionItem = new Framework.Xaml.ActionForm.ActionItemModel
                {
                    ...
                    Title = Elmah.Resx.UIStringResourcePerApp.ElmahStatusCode, // some localized text here, e.g. Framework.Resx.UIStringResource. or NTierOnTime.Resx.UIStringResourcePerApp, or NTierOnTime.Resx.UIStringResourcePerEntity
            ...
            {
                var vm = DependencyService.Resolve<Elmah.MVVMLightViewModels.ElmahStatusCode.IndexVM>();
                MessagingCenter.Send<Elmah.MVVMLightViewModels.ElmahStatusCode.IndexVM, Framework.Xaml.LoadListDataRequest>(vm, Elmah.MVVMLightViewModels.ElmahStatusCode.IndexVM.MessageTitle_LoadData,
                    new Framework.Xaml.LoadListDataRequest
                    {
                        ...
                        , Parameters = new Dictionary<string, object> {
                                    { nameof(Elmah.DataSourceEntities.ElmahStatusCode.oneCondition), oneCondition },
                                    // { nameof(Elmah.DataSourceEntities.ElmahStatusCode.BusinessEntityID), businessEntityID }, // can be more
                        }
...
*/
            ...
            // 7. override methods
            /*
            protected override Framework.Xaml.ActionForm.ActionItemModel GetSwitchToEditActionItemModel(Elmah.MVVMLightViewModels.ElmahStatusCode.ItemVM itemVM)
            {
