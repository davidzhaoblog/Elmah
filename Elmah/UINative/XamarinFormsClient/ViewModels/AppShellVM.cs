...
namespace Elmah.XamarinForms.ViewModels
{
    public class AppShellVM : Framework.Xaml.AppShellVM
    {
        ...
        public AppShellVM()
        {
            ...
            ELMAH_Error_NavigateToCommandParam_CommonResultView = NavigationVM.ELMAH_Error.GetNavigateToCommandParam_CommonResultView(0, listItemViewMode, false, nameof(Elmah.DataSourceEntities.ELMAH_Error.Message), Framework.Queries.QueryOrderDirections.Descending);
            // 3.1.2.1 ElmahApplication.CommonResultView
            //ElmahApplication_NavigateToCommandParam_CommonResultView = NavigationVM.ElmahApplication.GetNavigateToCommandParam_CommonResultView(0, listItemViewMode, false, nameof(Elmah.DataSourceEntities.DataSourceEntity.??), Framework.Queries.QueryOrderDirections.Descending);
            // 3.1.3.1 ElmahHost.CommonResultView
            //ElmahHost_NavigateToCommandParam_CommonResultView = NavigationVM.ElmahHost.GetNavigateToCommandParam_CommonResultView(0, listItemViewMode, false, nameof(Elmah.DataSourceEntities.DataSourceEntity.??), Framework.Queries.QueryOrderDirections.Descending);
            // 3.1.4.1 ElmahSource.CommonResultView
            //ElmahSource_NavigateToCommandParam_CommonResultView = NavigationVM.ElmahSource.GetNavigateToCommandParam_CommonResultView(0, listItemViewMode, false, nameof(Elmah.DataSourceEntities.DataSourceEntity.??), Framework.Queries.QueryOrderDirections.Descending);
            // 3.1.5.1 ElmahStatusCode.CommonResultView
            //ElmahStatusCode_NavigateToCommandParam_CommonResultView = NavigationVM.ElmahStatusCode.GetNavigateToCommandParam_CommonResultView(0, listItemViewMode, false, nameof(Elmah.DataSourceEntities.DataSourceEntity.??), Framework.Queries.QueryOrderDirections.Descending);
            // 3.1.6.1 ElmahType.CommonResultView
            //ElmahType_NavigateToCommandParam_CommonResultView = NavigationVM.ElmahType.GetNavigateToCommandParam_CommonResultView(0, listItemViewMode, false, nameof(Elmah.DataSourceEntities.DataSourceEntity.??), Framework.Queries.QueryOrderDirections.Descending);
            // 3.1.7.1 ElmahUser.CommonResultView
            //ElmahUser_NavigateToCommandParam_CommonResultView = NavigationVM.ElmahUser.GetNavigateToCommandParam_CommonResultView(0, listItemViewMode, false, nameof(Elmah.DataSourceEntities.DataSourceEntity.??), Framework.Queries.QueryOrderDirections.Descending);

            // 3.2.1.1 PetStore.Order.ListPage
            //PetStore_Order_NavigateToCommandParam_ListPage = NavigationVM_PetStore.Order.GetNavigateToCommandParam_ListPage(0, listItemViewMode, false, nameof(Elmah.PetStore.Models.{0}.?), Framework.Queries.QueryOrderDirections.Descending);
            ...
            PetStore_Pet_NavigateToCommandParam_ListPage = NavigationVM_PetStore.Pet.GetNavigateToCommandParam_ListPage(0, listItemViewMode, false, nameof(Elmah.PetStore.Models.Pet.Status), Framework.Queries.QueryOrderDirections.Descending);
        }
    }
}
