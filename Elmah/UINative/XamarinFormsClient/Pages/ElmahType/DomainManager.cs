...
namespace Elmah.XamarinForms.Pages.ElmahType
{
    public class DomainManager : Framework.Xamariner.Interfaces.IDomainManager
    {
        ...
        public Framework.Xaml.DomainModel CreateDomainModel()
        {
            ...
            //domainModel.AddRelativeRoute(Framework.Xaml.StandardRouteRelativeKey.Create.ToString(), typeof(Elmah.XamarinForms.Pages.ElmahType.Create), false);
            //domainModel.AddRelativeRoute(Framework.Xaml.StandardRouteRelativeKey.Delete.ToString(), typeof(Elmah.XamarinForms.Pages.ElmahType.Delete), false);
            //domainModel.AddRelativeRoute(Framework.Xaml.StandardRouteRelativeKey.Details.ToString(), typeof(Elmah.XamarinForms.Pages.ElmahType.Details), false);
            //domainModel.AddRelativeRoute(Framework.Xaml.StandardRouteRelativeKey.Edit.ToString(), typeof(Elmah.XamarinForms.Pages.ElmahType.Edit), false);
            ...
            //domainModel.AddRelativeRoute(Framework.Xaml.StandardRouteRelativeKey.CommonSearchView.ToString(), typeof(Elmah.XamarinForms.Pages.ElmahType.CommonSearchView), false);

            // 03.02. CommonResultView -> Elmah.XamarinForms.Pages.ElmahType.CommonResultView
            domainModel.AddRelativeRoute(Framework.Xaml.StandardRouteRelativeKey.CommonResultView.ToString(), typeof(Elmah.XamarinForms.Pages.ElmahType.CommonResultView), false);
