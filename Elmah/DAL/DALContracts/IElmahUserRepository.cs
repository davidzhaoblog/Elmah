...
namespace Elmah.DALContracts
{
    ...
    /// </summary>
    public interface IElmahUserRepository: Framework.Repositories.DataAccessLayerContractBase<List<Elmah.DataSourceEntities.ElmahUser>, Elmah.DataSourceEntities.ElmahUser, Elmah.DataSourceEntities.ElmahUserIdentifier, Elmah.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionElmahUser>
    {
        ...
        Task<Elmah.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionElmahUser> GetCollectionOfEntityByCommon(
            Framework.Queries.QuerySystemStringContainsCriteria user
            ,int currentIndex = -1
            ,int pageSize = -1
            ,Framework.Queries.QueryOrderBySettingCollection queryOrderBySettingCollection = null
        ...
        Task<Elmah.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionElmahUser> GetCollectionOfEntityByIdentifier(
            Framework.Queries.QuerySystemStringEqualsCriteria user
            ,int currentIndex = -1
            ,int pageSize = -1
            ,Framework.Queries.QueryOrderBySettingCollection queryOrderBySettingCollection = null
