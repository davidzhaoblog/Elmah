...
{
    public class UnitTestElmahApplication: Elmah.UnitTests._UnitTestBase
    {

        public UnitTestElmahApplication()
            : base("/ElmahApplicationApi")
        {
        }
        ...
        public async Task TestMethod_GetIndexVM()
        {
            ...
            var vm = new Elmah.ViewModelData.ElmahApplication.IndexVM();

            var response = await Post<Elmah.ViewModelData.ElmahApplication.IndexVM>(url, vm);
        }
