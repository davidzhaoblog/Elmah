...
{
    public class UnitTestElmahUser: Elmah.UnitTests._UnitTestBase
    {

        public UnitTestElmahUser()
            : base("/ElmahUserApi")
        {
        }
        ...
        public async Task TestMethod_GetIndexVM()
        {
            ...
            var vm = new Elmah.ViewModelData.ElmahUser.IndexVM();

            var response = await Post<Elmah.ViewModelData.ElmahUser.IndexVM>(url, vm);
        }
