...
{
    public class UnitTestElmahSource: Elmah.UnitTests._UnitTestBase
    {

        public UnitTestElmahSource()
            : base("/ElmahSourceApi")
        {
        }
        ...
        public async Task TestMethod_GetIndexVM()
        {
            ...
            var vm = new Elmah.ViewModelData.ElmahSource.IndexVM();

            var response = await Post<Elmah.ViewModelData.ElmahSource.IndexVM>(url, vm);
        }
