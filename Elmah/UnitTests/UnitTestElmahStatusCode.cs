...
{
    public class UnitTestElmahStatusCode: Elmah.UnitTests._UnitTestBase
    {

        public UnitTestElmahStatusCode()
            : base("/ElmahStatusCodeApi")
        {
        }
        ...
        public async Task TestMethod_GetIndexVM()
        {
            ...
            var vm = new Elmah.ViewModelData.ElmahStatusCode.IndexVM();

            var response = await Post<Elmah.ViewModelData.ElmahStatusCode.IndexVM>(url, vm);
        }
