...
namespace WebApiControllers_ElmahStatusCodeController
{
    // [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    [Route("/api/[controller]/[action]")]
    public partial class WebApiControllers_ElmahStatusCodeController : Controller
    {
        IElmahStatusCodeService _thisService { get; set; }
        private readonly IServiceProvider _serviceProvider;
        private readonly ILogger<WebApiControllers_ElmahStatusCodeController> _logger;

        public WebApiControllers_ElmahStatusCodeController(IElmahStatusCodeService thisService, IServiceProvider serviceProvider, ILogger<WebApiControllers_ElmahStatusCodeController> logger)
        {
