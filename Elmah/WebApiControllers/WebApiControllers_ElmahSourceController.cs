...
namespace WebApiControllers_ElmahSourceController
{
    // [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    [Route("/api/[controller]/[action]")]
    public partial class WebApiControllers_ElmahSourceController : Controller
    {
        IElmahSourceService _thisService { get; set; }
        private readonly IServiceProvider _serviceProvider;
        private readonly ILogger<WebApiControllers_ElmahSourceController> _logger;

        public WebApiControllers_ElmahSourceController(IElmahSourceService thisService, IServiceProvider serviceProvider, ILogger<WebApiControllers_ElmahSourceController> logger)
        {
