...
{
    public class BusinessLogicLayerRequestMessageBase
    {
        /// <summary>
        ...
        /// </value>
        [DataMember]
        public Framework.Queries.QueryPagingSetting QueryPagingSetting { get; set; } = new Framework.Queries.QueryPagingSetting(-1, -1);
    }
    ...
    public class BusinessLogicLayerRequestMessageBase<TQueryCriteria>: BusinessLogicLayerRequestMessageBase
        where TQueryCriteria : class, new()
    {
        #region constructors
            ...
            , string queryOrderByExpression)
        {
            ...
            this.QueryPagingSetting = new Framework.Queries.QueryPagingSetting(currentIndex, pageSize);
            this.QueryOrderBySettingCollection = new Framework.Queries.QueryOrderBySettingCollection(queryOrderByExpression);
        }
        ...
        /// </value>
        [DataMember]
        public TQueryCriteria Criteria { get; set; } = new TQueryCriteria();
