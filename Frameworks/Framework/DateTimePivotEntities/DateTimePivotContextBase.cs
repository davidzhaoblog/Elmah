...
namespace Framework.DateTimePivotEntities
{
        ...
        where TSummary : class, new()
    {
        ...
        /// </summary>
        public Framework.Queries.QuerySystemDateTimeRangeCriteria Criteria { get; private set; }
        ...
        /// </value>
        Func<Framework.Queries.QuerySystemDateTimeRangeCriteria, TCollection, TCollection> Func_GetEntityCollectionOfOneCriteria { get; set; }
