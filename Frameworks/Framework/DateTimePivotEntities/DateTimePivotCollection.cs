...
namespace Framework.DateTimePivotEntities
{
    ...
    public class DateTimePivotCollection<TCollection, T, TCategoryCollection, TCategory, TSubSummary>
        : List<Framework.DateTimePivotEntities.DateTimePivot<TCollection, T, TCategory, TSubSummary>>
        ...
        where TSubSummary : class, new()
    {
        ...
        public DateTimePivotCollection(IEnumerable<Framework.DateTimePivotEntities.DateTimePivot<TCollection, T, TCategory, TSubSummary>> input)
            : base(input)
        {
        }
