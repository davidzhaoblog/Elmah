...
namespace Framework.DateTimePivotEntities
{
...

    {
        ...
        public DateTimePivot(
            TCategory category
            , TCollection entityCollection
            , Framework.Queries.QuerySystemDateTimeRangeCriteria[] consecutiveDistributionCriteria)
        {
        ...
        /// </summary>
        public void DistributeEntityCollection(Framework.Queries.QuerySystemDateTimeRangeCriteria[] _ConsecutiveDistributionCriteria)
        {
            TCollection _EntityCollection = this.EntityCollection;
            Func<Framework.Queries.QuerySystemDateTimeRangeCriteria, TCollection, TCollection> _Func_GetEntityCollectionOfOneCriteria = this.Func_GetEntityCollectionOfOneCriteria;
        ...
        public static TCollection[] DistributeEntityCollection(TCollection _EntityCollection, Framework.Queries.QuerySystemDateTimeRangeCriteria[] _ConsecutiveDistributionCriteria, Func<Framework.Queries.QuerySystemDateTimeRangeCriteria, TCollection, TCollection> _Func_GetEntityCollectionOfOneCriteria)
        {
            List<TCollection> _DistributeEntityCollection = new List<TCollection>();
            if (_Func_GetEntityCollectionOfOneCriteria != null)
            {
                ...
                {
                    foreach (Framework.Queries.QuerySystemDateTimeRangeCriteria _OneCriteria in _ConsecutiveDistributionCriteria)
                    {
        ...
        Func<Framework.Queries.QuerySystemDateTimeRangeCriteria, TCollection, TCollection> Func_GetEntityCollectionOfOneCriteria = null;
